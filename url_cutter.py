...
import pyperclip
import webbrowser
>>>>>>> c7d5fc0 (Локальные изменения перед обновлением)
...
<<<<<<< HEAD
    image = ft.Image(
        src="C:\\Users\\Administrator\\PycharmProjects\\Apps\\Url_Cutter\\img\\icon scissors.png",
        width=150,
        height=150,
    )
=======
...
<<<<<<< HEAD
    ...
    left_container = ft.Column(
        ...
        width=90,
        alignment=ft.MainAxisAlignment.START,  # Adjust as necessary
    )
